 ...
 */
@RestController
@RequestMapping(WebConstants.QUESTIONS)
public class QuestionController extends WebServicesController {
    ...
    public @ResponseBody
    Challenge createChallenge(@JsonView(Views.ToBackEnd.class) @RequestBody QuestionService.ChallengeInfo info) {

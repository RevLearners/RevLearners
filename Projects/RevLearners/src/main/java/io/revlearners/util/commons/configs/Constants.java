 ...
 * database constant records. These include the values of report types,
 * question difficulties, etc; each table has a dedicated dictionary that
 * maps where the keys are the record ids and the value is the associated
 * string (usually name), or bean if the object is more than just a string
 * and an id
 */
...
//	to a mail server but not delivered to the receiver
    ...
    static {
        javaRanks.put(JRANKS_BEGINNER, new Rank(JRANKS_BEGINNER, JRANKS_BEGINNER_STR, JRANKS_BEGINNER_RANK, JRANKS_BEGINNER_THRESHOLD));
        javaRanks.put(JRANKS_INTERMEDIATE, new Rank(JRANKS_INTERMEDIATE, JRANKS_INTERMEDIATE_STR, JRANKS_INTERMEDIATE_RANK, JRANKS_INTERMEDIATE_THRESHOLD));
        javaRanks.put(JRANKS_EXPERT, new Rank(JRANKS_EXPERT, JRANKS_EXPERT_STR, JRANKS_EXPERT_RANK, JRANKS_EXPERT_THRESHOLD));
        javaRanks.put(JRANKS_JGURU, new Rank(JRANKS_JGURU, JRANKS_JGURU_STR, JRANKS_JGURU_RANK, JRANKS_JGURU_THRESHOLD));

        angular4Ranks.put(ANG4RANKS_BEGINNER, new Rank(ANG4RANKS_BEGINNER, ANG4RANKS_BEGINNER_STR, ANG4RANKS_BEGINNER_RANK, ANG4RANKS_BEGINNER_THRESHOLD));
        angular4Ranks.put(ANG4RANKS_INTERMEDIATE, new Rank(ANG4RANKS_INTERMEDIATE, ANG4RANKS_INTERMEDIATE_STR, ANG4RANKS_INTERMEDIATE_RANK, ANG4RANKS_INTERMEDIATE_THRESHOLD));
        angular4Ranks.put(ANG4RANKS_EXPERT, new Rank(ANG4RANKS_EXPERT, ANG4RANKS_EXPERT_STR, ANG4RANKS_EXPERT_RANK, ANG4RANKS_EXPERT_THRESHOLD));
        angular4Ranks.put(ANG4RANKS_NGACE, new Rank(ANG4RANKS_NGACE, ANG4RANKS_NGACE_STR, ANG4RANKS_NGACE_RANK, ANG4RANKS_NGACE_THRESHOLD));

        devOpsRanks.put(DVOPSRANKS_BEGINNER, new Rank(DVOPSRANKS_BEGINNER, DVOPSRANKS_BEGINNER_STR, DVOPSRANKS_BEGINNER_RANK, DVOPSRANKS_BEGINNER_THRESHOLD));
        devOpsRanks.put(DVOPSRANKS_INTERMEDIATE, new Rank(DVOPSRANKS_INTERMEDIATE, DVOPSRANKS_INTERMEDIATE_STR, DVOPSRANKS_INTERMEDIATE_RANK, DVOPSRANKS_INTERMEDIATE_THRESHOLD));
        devOpsRanks.put(DVOPSRANKS_EXPERT, new Rank(DVOPSRANKS_EXPERT, DVOPSRANKS_EXPERT_STR, DVOPSRANKS_EXPERT_RANK, DVOPSRANKS_EXPERT_THRESHOLD));
        devOpsRanks.put(DVOPSRANKS_SCRUM_LORD, new Rank(DVOPSRANKS_SCRUM_LORD, DVOPSRANKS_SCRUM_LORD_STR, DVOPSRANKS_SCRUM_LORD_RANK, DVOPSRANKS_SCRUM_LORD_THRESHOLD));

        hibernateRanks.put(HBMRANKS_BEGINNER, new Rank(HBMRANKS_BEGINNER, HBMRANKS_BEGINNER_STR, HBMRANKS_BEGINNER_RANK, HBMRANKS_BEGINNER_THRESHOLD));
        hibernateRanks.put(HBMRANKS_INTERMEDIATE, new Rank(HBMRANKS_INTERMEDIATE, HBMRANKS_INTERMEDIATE_STR, HBMRANKS_INTERMEDIATE_RANK, HBMRANKS_INTERMEDIATE_THRESHOLD));
        hibernateRanks.put(HBMRANKS_EXPERT, new Rank(HBMRANKS_EXPERT, HBMRANKS_EXPERT_STR, HBMRANKS_EXPERT_RANK, HBMRANKS_EXPERT_THRESHOLD));
        hibernateRanks.put(HBMRANKS_HBMASTER, new Rank(HBMRANKS_HBMASTER, HBMRANKS_HBMASTER_STR, HBMRANKS_HBMASTER_RANK, HBMRANKS_HBMASTER_THRESHOLD));

        designPatternRanks.put(DPRANKS_BEGINNER, new Rank(DPRANKS_BEGINNER, DPRANKS_BEGINNER_STR, DPRANKS_BEGINNER_RANK, DPRANKS_BEGINNER_THRESHOLD));
        designPatternRanks.put(DPRANKS_INTERMEDIATE, new Rank(DPRANKS_INTERMEDIATE, DPRANKS_INTERMEDIATE_STR, DPRANKS_INTERMEDIATE_RANK, DPRANKS_INTERMEDIATE_THRESHOLD));
        designPatternRanks.put(DPRANKS_EXPERT, new Rank(DPRANKS_EXPERT, DPRANKS_EXPERT_STR, DPRANKS_EXPERT_RANK, DPRANKS_EXPERT_THRESHOLD));
        designPatternRanks.put(DPRANKS_MASTER, new Rank(DPRANKS_MASTER, DPRANKS_MASTER_STR, DPRANKS_MASTER_RANK, DPRANKS_MASTER_THRESHOLD));

        certifications.put(ORACLE_CERTIFIED_ASSOCIATE, new Certification(ORACLE_CERTIFIED_ASSOCIATE, ORACLE_CERTIFIED_ASSOCIATE_STR, new Topic(TOPIC_CORE_JAVA)));
        ...
        questionDifficulties.put(DIFFICULTY_HARD, new QuestionDifficulty(DIFFICULTY_HARD, DIFFICULTY_HARD_STR, DIFFICULTY_HARD_MULTIPLIER));
        questionDifficulties.put(DIFFICULTY_VERY_HARD, new QuestionDifficulty(DIFFICULTY_VERY_HARD, DIFFICULTY_VERY_HARD_STR, DIFFICULTY_VERY_HARD_MULTIPLIER));
        ...
        questionReasons.put(QREASON_WRONG, new Reason(QREASON_WRONG, QREASON_WRONG_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));
        questionReasons.put(QREASON_OFF_TOPIC, new Reason(QREASON_OFF_TOPIC, QREASON_OFF_TOPIC_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));
        questionReasons.put(QREASON_NOT_A_QUESTION, new Reason(QREASON_NOT_A_QUESTION, QREASON_NOT_A_QUESTION_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));
        questionReasons.put(QREASON_TOO_VAGUE, new Reason(QREASON_TOO_VAGUE, QREASON_TOO_VAGUE_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));
        questionReasons.put(QREASON_CONFUSING, new Reason(QREASON_CONFUSING, QREASON_CONFUSING_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));
        questionReasons.put(QREASON_WRONG_DIFFICULTY, new Reason(QREASON_WRONG_DIFFICULTY, QREASON_WRONG_DIFFICULTY_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));
        questionReasons.put(QREASON_OTHER, new Reason(QREASON_OTHER, QREASON_OTHER_STR, "Todo: insert description", new ReasonType(REASON_TYPE_QUESTION)));

        userReasons.put(USER_REASON_ABUSIVE, new Reason(USER_REASON_ABUSIVE, USER_REASON_ABUSIVE_STR, "Todo: insert description", new ReasonType(REASON_TYPE_USER)));
        userReasons.put(USER_REASON_FAKE_ACCOUNT, new Reason(USER_REASON_FAKE_ACCOUNT, USER_REASON_FAKE_ACCOUNT_STR, "Todo: insert description", new ReasonType(REASON_TYPE_USER)));
        userReasons.put(USER_REASON_STOLEN_INTELLECTUAL_PROPERTY, new Reason(USER_REASON_STOLEN_INTELLECTUAL_PROPERTY, USER_REASON_STOLEN_INTELLECTUAL_PROPERTY_STR, "Todo: insert description", new ReasonType(REASON_TYPE_USER)));
        userReasons.put(USER_REASON_SPAMMER, new Reason(USER_REASON_SPAMMER, USER_REASON_SPAMMER_STR, "Todo: insert description", new ReasonType(REASON_TYPE_USER)));
        userReasons.put(USER_REASON_OTHER, new Reason(USER_REASON_OTHER, USER_REASON_OTHER_STR, "Todo: insert description", new ReasonType(REASON_TYPE_USER)));

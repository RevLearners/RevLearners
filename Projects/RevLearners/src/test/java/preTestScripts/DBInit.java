...
public class DBInit {
     ...
     * @param correctIdx
     */
    public static void persistQuestion(String questionText, long topicId, long typeId, long difficultyId, String[] optionTexts, int correctIdx, String explanation, Session session) {
    ...
    private static void addQuestions(Session session) {
        persistQuestion(
                "Arrays in Java are inherit from:",
                Constants.TOPIC_CORE_JAVA,
                Constants.QUESTION_MULTI_CHOICE,
                Constants.DIFFICULTY_EASY,
                new String[]{
